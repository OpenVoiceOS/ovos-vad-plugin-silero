...
- chore: add missing shared CI workflows [\#32](https://github.com/OpenVoiceOS/ovos-vad-plugin-silero/pull/32) ([JarbasAl](https://github.com/JarbasAl))

## [0.1.3a2](https://github.com/OpenVoiceOS/ovos-vad-plugin-silero/tree/0.1.3a2) (2026-06-14)

[Full Changelog](https://github.com/OpenVoiceOS/ovos-vad-plugin-silero/compare/0.1.3a1...0.1.3a2)

**Merged pull requests:**

- test: ovoscope listener e2e \(real silero VAD\) [\#30](https://github.com/OpenVoiceOS/ovos-vad-plugin-silero/pull/30) ([JarbasAl](https://github.com/JarbasAl))
